    ...
    <div class="aboutMain">
        <div class="aboutTile cardShadow aboutProject">
            <div class="aboutText">
                ...
                <p>GoodieMaticAa is a vending machine used at Ter AA. It delivers products chosen by the school or
                    students.
                </p>

                <h2>How It Works</h2>
                <p>Students order products on the website using an authentication code given by a teacher or student.
                    The
